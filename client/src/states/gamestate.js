...
exports._loadLevel = function (data, resultsData) {
  ...
  //this.dynamicSpriteSheet = this.game.add.group();
  // spawn all platforms
  //resultsData.forEach(this._spawnPlatform, this);
  this._spawnPlatform(resultsData, this);
  //spawn heroes and enemies
  this._spawnCharacters({hero: data.hero, spiders: data.spiders});
  //spawn important objects
  data.coins.forEach(this._spawnCoin, this);
  //spawn dynamic spritesheet
  //this._spawnDynamicSpriteSheet(0, 0);
...
exports._spawnDynamicSpriteSheet= function(x, y){
  const sprite = this.dynamicSpriteSheet.create(x, y, 'myDynamicSpritesheet');
...
exports._spawnPlatform = function (results) {
